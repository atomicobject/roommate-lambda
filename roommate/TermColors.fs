namespace Roommate
module TermColors =
    //https://gist.github.com/vbfox/f8857242d6b0ce0e4de1e02e2d3f15a0
    ...
    let setBgRgb rgb = 48::2::rgb |> selectGraphicRendition
    let saveCursorPos () = printcsif "%is"
    let restoreCursorPos () = printcsif "%iu"
    let printBgColored rgb s = setBgRgb rgb; printf "%s" s;resetColor()
